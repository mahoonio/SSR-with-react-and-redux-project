...
var FETCH_USERS = exports.FETCH_USERS = 'fetch_users'; //type
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              res = _context.sent;
              // api is the custom axios instance provided by redux thunk
...
exports.default = [_extends({}, _App2.default, {
  routes: [_extends({}, _HomePage2.default, {
    path: '/',
    exact: true
  }), _extends({}, _AdminsListPage2.default, { path: '/admins' }), _extends({}, _UsersListPage2.default, { path: '/users' }), _extends({}, _NotFoundPage2.default)]
})];
...
var Home = function Home() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      { style: { fontSize: '22px' } },
      'checkout these awsome features around server side rendering. built with react,redux,nodejs and express'
    ),
    _react2.default.createElement(
      'p',
      { style: { fontSize: '20px' } },
    ...
    _react2.default.createElement(
      'p',
      { style: { fontSize: '18px' } },
      'the project was developed for learning purposes with inspiration of react ssr course of stephen grider. 25/08/2022'
    )
  );
};
...
exports.default = function (ChildComponent) {
    ...
    _createClass(RequireAuth, [{
      ...
      value: function render() {
        switch (this.props.auth) {
          ...
          default:
            return _react2.default.createElement(ChildComponent, null);
        }
      }
    }]);
  ...
  return (0, _reactRedux.connect)(mapStateToProps)(ChildComponent);
};
